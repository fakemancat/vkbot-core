...
const admins = []; //Массив с айди админов, писать в формате: [123456789, 123456788, 123456787] и так далее, где все эти числа - айди ваших админов
const vips = []; // Массив с айди випов. Оформлять так же как и массив с админами.
let bot_name_string = ""; // Тут имена бота. Сразу и для регекса.
