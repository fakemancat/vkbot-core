...
4. Настроить конфигурации для бота. Всё нужное нзакомментированно в самом файле config.js
...
5. Настроить конфигурации для бота. Всё нужное нзакомментированно в самом файле config.js
