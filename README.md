...
#### Для групп:
Если вы ставите бота в группу, то придётся ещё и настроить группу. Это совсем не сложно:
...
5. Открываем типы событий и отмечаем: Входящее сообщение, Статус набора теста и Разрешение на получение
